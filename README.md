...
`hostname/tasks/{taskName}/tags "GET"` - запрос на получение тэгов задания
...
`/developers/tasks/addTags/{taskName} "POST"` - запрос на добавление тэгов к заданию
...
###hostname/tasks/{taskName}/tags "GET"
